...
namespace CompactAsset\Service;

class CompactAssetService {
     ...
     * 
     * @param type $_script
     * @param type $_encoding
     * @param type $_fastDecode
     * @param type $_specialChars
     */
    ...
    private function _bootStrap($packed, $keywords)
    {
        ...
        $unpackPacker = new CompactAssetService($unpack, 0, false, true);
