$(function () {
    ...
    $("#tablesorterBonusPagos").tablesorter({
    ...
    $('#filtrarRelatorioBonusPagos').click(function () {
    ...
    $('#limparRelatorioBonusPagos').click(function () {
    ...
    $("#imprimirRelatorioBonusPagos").click(function () {
